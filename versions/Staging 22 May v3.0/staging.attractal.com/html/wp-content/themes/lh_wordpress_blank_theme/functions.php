...
<!-- Breadcrumbs http://www.qualitytuts.com/wordpress-custom-breadcrumbs-without-plugin // add <?php if (function_exists('qt_custom_breadcrumbs')) qt_custom_breadcrumbs(); ?>//-->

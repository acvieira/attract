            ...
            <div class="container">
                <div class="row">
                    <div class="three columns">
                        <h3>ATTRACTAL</h3>
                        <ul>
                            <li><a href="about">About us - GENOTYPE</a></li>
                            <li><a href="mission-statement">Mission Statement</a></li>
                            <li><a href="services">Services - PHENOTYPE</a></li>
                    ...
                    <div class="three columns">
                        <h3>CONSULTING</h3>
                        <ul>
                            <li><a href="adaptability-and-co-evolution">Corporate Adaptability and Co-evolution</a></li>
                            <li><a href="fitness-and-performance">Corporate Fitness and Performance</a></li>
                            <li><a href="structure-and-control">Corporate Structure and Control </a></li>
                            <li><a href="learning-and-loops">Corporate Collaborative Learning and Feedback Loops </a></li>
                        </ul>
                    </div>       
                    <div class="three columns">
                        <h3>TECHNOLOGY</h3>

<?php get_header(); ?>    
    ...
    <div class="row">
        ...
        <div class="three columns news">
    		<h3>consulting</h3>
            <p>ATTRACTAL envisions every corporation, and its environment, through the holistic lens of Complex Adaptive Systems. ATTRACTAL’s approaches, methodologies, models, and solutions are therefore inspired by the fundamentals and behaviors of these fascinating systems.

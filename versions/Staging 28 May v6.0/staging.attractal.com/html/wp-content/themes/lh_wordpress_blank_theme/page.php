    		...
    		<ul>
                ...
                <li class="silver"><a href="#">technology</a>
                    <ul>
                            ...
                            <li><a href="<?php echo home_url(); ?>/service-desk">> near shore service desk and it support</a></li>
                   </ul>
...
<?php if ( get_post_custom_values('comments') ) comments_template() // Add a custom field with Name and Value of "comments" to enable comments on this page ?>          <div id="joinus" class="two columns"></div>
            </div><!-- #content -->
